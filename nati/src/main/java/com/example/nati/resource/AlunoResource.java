...
import com.example.nati.service.AlunoService;
...
public class AlunoResource {
	...
	@GetMapping("/{codigo}")
	public Optional<Aluno> buscarAlunoPorCodigo(@PathVariable Long codigo){
	...
	public void atualizarPropriedade(@PathVariable Long codigo, @RequestBody Boolean ativo) {
		 alunoService.atualizarPropriedadeAtiva(codigo, ativo);
